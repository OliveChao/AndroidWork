...
public class MainPage extends ActionBarActivity implements OnItemClickListener {
	private ListView listView;
	private ArrayAdapter<String> stringArrayAdapter;
	String []items = {"Addition","Subtraction","Login Form","Increament and Decreament","Button Toast","Countries"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //Initialization
      		...
      		//Design the ListView
      		stringArrayAdapter = new ArrayAdapter<String>(this, R.layout.list_layout,itemList);
